...
def get_overlaping_bins(mags, dict_cogbin_unitigs, cog_threshold, overlap_threshold):
...
def main(mag_list, cog_threshold, bins_to_merge, cogs_to_ignore, bins_to_process, rel_path, overlap_threshold):
    ...
    while flag==True:
        ...
        dict_to_flag_new, dict_merge_bins_new = get_overlaping_bins(mags, dict_cogbin_unitigs_merged, cog_threshold, overlap_threshold)
...
if __name__ == "__main__":
    ...
    parser.add_argument("mag_list", help="List of mags that can be merged")    
    parser.add_argument("cog_threshold", help="number of cogs in common between bins to require merging")
