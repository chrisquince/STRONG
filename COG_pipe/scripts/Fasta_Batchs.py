...
def main(fasta_file, Number_batch, Temp_dir):
    ...
    process = Popen(['grep -c ">" ' + fasta_file],
...
if __name__ == "__main__":
    ...
    parser.add_argument(
        "fasta_file", help="fasta file you want to cut in batchs")
    parser.add_argument("Number_batch", help="total number of batchs")
    parser.add_argument(
        "-t", help="temp directory where you want all your batchs", default='./temp_batchs/')
