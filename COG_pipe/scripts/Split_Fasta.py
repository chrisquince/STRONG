...
def main(fasta_file, nb_chunks, output):
    ...
    def Current_filename(x): return fasta_path+"_"+str(x)+extension
...
if __name__ == "__main__":
    ...
    parser.add_argument(
        "Fasta_file", help="fasta file you want to split in chuncks")
    parser.add_argument("nb_chunks", help="nb of Chunks")
    parser.add_argument(
        "-o", help="Name of the folder where you want to store the chunks", default="Split_")
