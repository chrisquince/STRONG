...
def main(argv):
    ...
    try:
        ...
        with open(args.assign_file) as g:
            ...
            for line in g:
                ...
                strainBest[strainj].append((haploj,err))
    ...
    for strain, cov in strains.items():
        ...
        if len(hits) > 0:
            ...
            print(strain + ",Found," + str(cov) + "," + str(sorted_by_err[0][1]))
            
            for h in range(1,len(hits)):
                print(strain + ",Repeated," + str(cov) + "," + str(sorted_by_err[h][1]))


        else:
            print(strain + ",NotFound," + str(cov) + ",na")
